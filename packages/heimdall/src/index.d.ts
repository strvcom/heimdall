declare module '@strv/heimdall' {
  ...
  /**
   * Heimdall takes control over the Node.js process' signal handling and provides a simple way to
   * respond to various process lifecycle events.
   */
  export function heimdall(delegate: Delegate): void
}
